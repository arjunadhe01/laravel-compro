                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            ...
                            <a href="https://github.com/Kuroyasha11" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="{{ asset('assets/img/Kuroyasha.png') }}" alt="Kuroyasha">
                                </span>
                                <span class="app-brand-text demo text-body fw-bolder text-uppercase">Kuroyasha</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2 fs-5">Welcome to Kuroyasha's ComPro! 👋</h4>
